...
namespace EuroText2
{
    ...
    {
        //-------------------------------------------------------------------------------------------------------------------------------
        internal void CreateDataInfo(BackgroundWorker bw, ISheet FormatInfo, IWorkbook workbook)
        {
            //-------------------------------------------------------------------------------------------
            //  Fonts
            //-------------------------------------------------------------------------------------------
            ...
            for (int i = 0; i < formatCodes.GetLength(0); i++)
            {
                ...
                bw.ReportProgress((i * 100) / formatCodes.GetLength(0), string.Join(" ", "Effect Format Codes:", formatCodes[i, 0], formatCodes[i, 1]));
            }
